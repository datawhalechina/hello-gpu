...
**实验状态**：本篇环境已迁移至 ROCm 7.13 / `gfx1201`，并在 Radeon RX 9070 XT + 原生 Ubuntu 24.04 上完成向量加法搜索与独立复测。该次搜索接受了一个候选，但复测未确认稳定加速。运行步骤、原始记录的职责和结果解释集中放在 [第 17 章](../chapter17/index.md)。

...
<template>
  <div v-if="chapter" class="hg-chapter-meta">
    ...
    <p v-if="chapter.number !== 19" class="hg-chapter-baseline"><UiIcon name="chip" :size="17" /><span>当前环境</span><span>Radeon RX 9070 XT <i>·</i> ROCm 10.0 <i>·</i> 原生 Ubuntu 24.04</span></p>

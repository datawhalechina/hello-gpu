...
def run_implementation(
    ...
    if not precheck.correct:
        print(
            ...
            f" shape={args.m}x{args.n}x{args.k} dtype=float32 m={args.m} n={args.n} k={args.k}"
            ...
            " timed=0 correct=FAIL precheck=FAIL postcheck=NA min_ms=NA median_ms=NA mean_ms=NA tflops=NA"
    ...
    print(
        ...
        " precheck=OK"
        f" postcheck={'OK' if postcheck.correct else 'FAIL'}"
